...
class ReplayMemory(object):
    ...
    def sample(
        ...
        samples = zip(*random.sample(self.memory,
                                     batch_size))
...
class Dqn():
    ...
    def learn(
        ...
        td_loss = F.smooth_l1_loss(outputs,
                                   target)
    ...
    def update(
        ...
        if len(self.memory.memory) > 100:
            batch_state, batch_new_state, batch_action, batch_reward = self.memory.sample(
                100)
